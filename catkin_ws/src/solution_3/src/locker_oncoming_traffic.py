...
if __name__ == "__main__":
    ...
    crossroads = [
        ...
        {'xy': (3.7, 6.05), 'walls': [[(3.28, 6.55), (3.7, 6.55)]]}, #block to #4
        {'xy': (3.74, 8.08), 'walls': [[(3.29, 7.66), (3.3, 8.1)], [(3.73, 7.66), (4.16, 7.65)], [(4.15, 8.1), (4.13, 8.5)]]}, #4
        {'xy': (6.72, 8.09), 'walls': [[(6.32, 7.65), (6.32, 8.1)]]}, #6
