...
if __name__ == "__main__":
    ...
    crossroads = [
        {'xy': (1.82, 5.18), 'walls': [[(7.3, 4.5), (8.24, 4.5)]]}, #start point
        {'xy': (1.82, 5.18), 'walls': [[(3.7, 6.55), (3.28, 6.55)]]}, #block to #4
        {'xy': (1.82, 5.18), 'walls': [[(3.3, 8.1), (3.3, 7.64)], [(3.73, 7.63), (4.16, 7.65)], [(4.15, 8.1), (4.13, 8.5)]]}, #4
        {'xy': (1.82, 5.18), 'walls': [[(6.32, 8.1), (6.32, 7.65)]]}, #6
        {'xy': (1.82, 5.18), 'walls': [[(2.14, 8.1), (2.14, 8.5)]]}  #5
    ]
